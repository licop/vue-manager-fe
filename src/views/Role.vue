      ...
      <el-table :data="roleList">
        ...
        <el-table-column fixed="right" label="操作" width="200">
          <template #default="scope">
            <el-button type="text" size="small" @click="handleEdit(scope.row)" v-has="'role-edit'">编辑</el-button>
            <el-button type="text" size="small" @click="handleOpenPermission(scope.row)" v-has="'role-permission'">设置权限</el-button>
            <el-button type="text" size="small" @click="handleDel(scope.row._id)" v-has="'role-delete'">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
