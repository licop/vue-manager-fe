      ...
      <el-table :data="menuList" row-key="_id" :tree-props="{ children: 'children' }">
        ...
        <el-table-column fixed="right" label="操作" width="180">
          <template #default="scope">
            <el-button type="text" size="small" @click="handleAdd(2, scope.row)" v-has="'menu-create'">新增</el-button>
            <el-button type="text" size="small" @click="handleEdit(scope.row)" v-has="'menu-edit'">编辑</el-button>
            <el-button type="text" size="small" @click="handleDel(scope.row._id)" v-has="'menu-delete'">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
