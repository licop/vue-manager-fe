      ...
      <el-table :data="userList" @selection-change="handleSelectionChange">
        ...
        <el-table-column fixed="right" label="操作" width="130">
          <template #default="scope">
            <el-button type="text" size="small" @click="handleEdit(scope.row)" v-has="'user-edit'"
              >编辑</el-button
            >
            <el-button type="text" size="small" @click="handleDel(scope.row)" v-has="'user-delete'"
              >删除</el-button
            >
          </template>
        </el-table-column>
      ...
      >
        ...
        <el-form-item label="邮箱" prop="userEmail">
          <el-input
            ...
            placeholder="请输入邮箱"
          >
            <template #append>@alibaba-inc.com</template>
          </el-input>
        </el-form-item>
    ...
    const handleSubmit = () => {
      proxy.$refs.dialogForm.validate(async (valid) => {
        if (valid) {
          ...
          params.userEmail += "@alibaba-inc.com";
